...
int main(int argc, char** argv) {
    ...
    const char *imageSingle = "../../sample/data/image_320_240_8_marker_id_simple_nr031.raw";
    const char *imageMulti = "../../sample/data/markerboard_480-499.raw";
    ...
    ts.init("../../sample/data/PGR_M12x0.5_2.5mm.cal", 1.0f, 1000.0f);
    ...
    tm.init("../../sample/data/PGR_M12x0.5_2.5mm.cal", "../../sample/data/markerboard_480-499.cfg", 1.0f, 1000.0f);
